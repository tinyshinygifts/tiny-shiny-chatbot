...
const apiKeys = [
  ...
  'META_ACCESS_TOKEN','META_AD_ACCOUNT_ID','META_FACEBOOK_PAGE_ID','META_PAGE_ID','META_INSTAGRAM_ACCOUNT_ID','META_IG_ACCOUNT_ID','META_PIXEL_ID','META_API_VERSION','OPENAI_API_KEY','OPENAI_MODEL','USE_CLOUDINARY','CLOUDINARY_URL','CLOUDINARY_CLOUD_NAME','CLOUDINARY_API_KEY','CLOUDINARY_API_SECRET','CLOUDINARY_FOLDER','META_DEFAULT_COST_PER_ORDER','DEFAULT_SHIPPING_COST',
...
const secretKeys = new Set(['OPENAI_API_KEY','CLOUDINARY_URL','CLOUDINARY_API_SECRET','META_ACCESS_TOKEN','SHOPIFY_ADMIN_ACCESS_TOKEN','SHOPIFY_CLIENT_SECRET','WHATSAPP_CLOUD_TOKEN','SHOPIFY_WEBHOOK_SECRET','GOOGLE_SHEETS_WEBHOOK_URL','GOOGLE_SHEETS_SECRET','SHIPROCKET_TOKEN','SHIPROCKET_PASSWORD','ADMIN_PASSWORD','ADMIN_DOB','SECURITY_SESSION_SECRET']);
...
function writeEnvFile(next) {
  ...
  const lines = [
    ...
    'META_FACEBOOK_PAGE_ID=' + (merged.META_FACEBOOK_PAGE_ID || merged.META_PAGE_ID || ''),
    'META_PAGE_ID=' + (merged.META_PAGE_ID || merged.META_FACEBOOK_PAGE_ID || ''),
    'META_INSTAGRAM_ACCOUNT_ID=' + (merged.META_INSTAGRAM_ACCOUNT_ID || merged.META_IG_ACCOUNT_ID || ''),
    'META_IG_ACCOUNT_ID=' + (merged.META_IG_ACCOUNT_ID || merged.META_INSTAGRAM_ACCOUNT_ID || ''),
    'META_PIXEL_ID=' + (merged.META_PIXEL_ID || ''),
    'META_API_VERSION=' + (merged.META_API_VERSION || 'v20.0'),
    'OPENAI_API_KEY=' + (merged.OPENAI_API_KEY || ''),
    'OPENAI_MODEL=' + (merged.OPENAI_MODEL || 'gpt-4.1-mini'),
    'USE_CLOUDINARY=' + (merged.USE_CLOUDINARY || 'false'),
    'CLOUDINARY_URL=' + (merged.CLOUDINARY_URL || ''),
    'CLOUDINARY_CLOUD_NAME=' + (merged.CLOUDINARY_CLOUD_NAME || ''),
    'CLOUDINARY_API_KEY=' + (merged.CLOUDINARY_API_KEY || ''),
    'CLOUDINARY_API_SECRET=' + (merged.CLOUDINARY_API_SECRET || ''),
    'CLOUDINARY_FOLDER=' + (merged.CLOUDINARY_FOLDER || 'tiny-shiny-chatbot'),
